          ...
          >
            ...
            <View>
              ...
              <View className="flex flex-row mt-2 mb-2">
                ...
                />
                <Text
                  style={{ ...COMMONTEXT.fifth, color: TEXTCOLOR.secondary }}
                >
                  {product.cost}
                </Text>
              </View>
              ...
              <Text style={{ ...COMMONTEXT.primary, marginTop: vh(1) }}>
                For any Queries :{" "}
              </Text>
              <TouchableOpacity onPress={handleChat}>
                <Text style={[styles.text, { color: TEXTCOLOR.secondary }]}>
                  Chat with Dealer via Whatsapp
                </Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={handleEmail}>
                <Text
                  style={[
                    styles.text,
                    { color: TEXTCOLOR.secondary, marginBottom: vh(1) },
                  ]}
                >
                  Mail Dealer : cukoobee2901@gmail.com
                </Text>
              </TouchableOpacity>
