...
const ItemScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.ItemScreenMainContainer}>
         ...
         <ScrollView showsVerticalScrollIndicator={false} alwaysBounceVertical={true}  contentContainerStyle={{
                paddingTop:vh(1),
                marginBottom:vh(1),       
            }}>
                <View style={styles.MainItemDisplay}>
                    ...
                    <Image source={{uri:urlFor(product.image).url()}} style={styles.MainItemImage}/>
                ...
                { product.offers ? <Text style={styles.Offer}>Offers: {product.offers}</Text> : ""}
                ...
                <View className={`flex flex-row p-10 pt-5 ${product.nft ? `justify-between`:`justify-center`}`}>
                    <TouchableOpacity className="bg-gray-800 shadow-lg shadow-slate-200 rounded-2xl" onPress={setNavigationStateBuy}>
                        <Text style={styles.btn}>Buy</Text>
                    </TouchableOpacity>

                    { product.nft ? 
                    <TouchableOpacity className="bg-gray-800 shadow-lg shadow-slate-200 rounded-2xl" onPress={setNavigationStateOwn}>
